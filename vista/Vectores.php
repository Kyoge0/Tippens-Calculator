        ...
        <div>
            <form action="../Results.php" method="GET" id="form" class="form">
                ...
                <div class="Vector-imp">
                    ...
                    <input type="number" class="form-imput" step="any" id="V-1" name="V-1" style="display: none">
                    <label for="Angulo" class="form-label" id="L-2" style="display: none">Ángulo 1:</label>
                    <input type="number" class="form-imput" step="any" id="A-1" name="A-1" style="display: none">
                    <label for="Vector" class="form-label" id="L-3" style="display: none">Magnitud 2:</label>
                    <input type="number" class="form-imput" step="any" id="V-2" name="V-2" style="display: none">
                    <label for="Angulo" class="form-label" id="L-4" style="display: none">Ángulo 2:</label>
                    <input type="number" class="form-imput" step="any" id="A-2" name="A-2" style="display: none">
                    <label for="Vector" class="form-label" id="L-5" style="display: none">Magnitud 3:</label>
                    <input type="number" class="form-imput" step="any" id="V-3" name="V-3" style="display: none">
                    <label for="Angulo" class="form-label" id="L-6" style="display: none">Ángulo 3:</label>
                    <input type="number" class="form-imput" step="any" id="A-3" name="A-3" style="display: none">
                    <label for="Vector" class="form-label" id="L-7" style="display: none">Magnitud 4:</label>
                    <input type="number" class="form-imput" step="any" id="V-4" name="V-4" style="display: none">
                    <label for="Angulo" class="form-label" id="L-8" style="display: none">Ángulo 4:</label>
                    <input type="number" class="form-imput" step="any" id="A-4" name="A-4" style="display: none">
                    <label for="Vector" class="form-label" id="L-9" style="display: none">Magnitud 5:</label>
                    <input type="number" class="form-imput" step="any" id="V-5" name="V-5" style="display: none">
                    <label for="Angulo" class="form-label" id="L-10" style="display: none">Ángulo 5:</label>
                    <input type="number" class="form-imput" step="any" id="A-5" name="A-5" style="display: none">
                    <label for="Vector" class="form-label" id="L-11" style="display: none">Magnitud 6:</label>
                    <input type="number" class="form-imput" step="any" id="V-6" name="V-6" style="display: none">
                    <label for="Angulo" class="form-label" id="L-12" style="display: none">Ángulo 6:</label>
                    <input type="number" class="form-imput" step="any" id="A-6" name="A-6" style="display: none">
