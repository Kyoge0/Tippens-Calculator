        ...
        <div id="form-cont" name="form-cont">
            <form action="../Results.php" method="get" id="form" class="form">
                ...
                <div class="Icontainer-flex">
                    ...
                    <label for="Vf" id="lbl2" class="form-label">Velocidad final:</label>
                    <input type="number" step="any" placeholder="m/s²" name="Vel-f" id="f-imp" class="form-imput">
                    <label for="T" id="lbl3" class="form-label">Tiempo:</label>
                    ...
                    <input type="number" value="2" name="temp" hidden>
                </div>
            </form>
        </div>
        <script src="JS/Pos-X1.js"></script>
    </body>
</html>